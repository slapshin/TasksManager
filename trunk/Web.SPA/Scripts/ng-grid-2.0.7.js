...
(function (window, $) {
    ...
    window.ngGrid.i18n['ru'] = {
        ...
        ngGroupPanelDescription: 'Перетащите заголовок колонки сюда и отпустите для того, чтобы сгруппировать по этой колонке.',
        ngSearchPlaceHolder: 'Поиск...',
        ngMenuText: 'Выберите колонки:',
        ngShowingItemsLabel: 'Показанные элементы:',
        ngTotalItemsLabel: 'Всего элементов:',
        ngSelectedItemsLabel: 'Выделенные элементы:',
