...
(function ($) {
    ...
    var pluginName = 'customCalendar',
        initAllSelector = '[data-role=customCalendar], .customCalendar',
    ...
    $[pluginName] = function (element, options) {
        ...
        plugin.init = function () {
            ...
            //patch
            if (date) {
                selectedDateString = moment(date).format('YYYY-MM-DD');
            }
        ...
        function fillCalendar() {
            ...
            var _calMoment = calMoment || moment().lang(lang);
            // header
            $header.text(_calMoment.format('MMM YYYY'));

            // this month
            var thisMonthMom = _calMoment.clone().startOf('month');
            var daysInMonth = _calMoment.daysInMonth();
            ...
            // prev month
            var prevMonthMom = _calMoment.clone().add('month', -1).endOf('month');
            ...
            // next month
            var nextMonthMom = _calMoment.clone().add('month', 1).startOf('month');
...
(function ($) {
    ...
    var pluginName = 'customDatepicker',
        initAllSelector = '[data-role=customDatepicker], .customDatepicker';
    paramKeys = ['InitDate', 'Lang', 'YearButtons'];
